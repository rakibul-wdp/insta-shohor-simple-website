...
const switchTab = (id) => {
  if (id === 'posts') {
    ...
    document.getElementById('liked-heading').style.display = 'none';
    document.getElementById('report-heading').style.display = 'none';
  } else if (id === 'liked') {
    document.getElementById('liked').style.display = 'block';
    document.getElementById('posts').style.display = 'none';
    document.getElementById('reported').style.display = 'none';
    document.getElementById('liked-heading').style.display = 'block';
    document.getElementById('report-heading').style.display = 'none';
    ...
    document.getElementById('liked').style.display = 'none';
    document.getElementById('liked-heading').style.display = 'none';
    document.getElementById('report-heading').style.display = 'block';
